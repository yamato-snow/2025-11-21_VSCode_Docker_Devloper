...
Express.jsは、Node.js上で動作する**業界標準の軽量Webフレームワーク**です。

**特徴:**
- ✅ **最も人気** - npm週間ダウンロード3000万+
- ✅ **シンプルなAPI** - 学習コストが低い、5分で動くものが作れる
- ✅ **求人が最も多い** - 業界標準、学習すれば仕事に直結
- ✅ **ミドルウェアアーキテクチャ** - リクエストをパイプラインで処理
- ❌ TypeScript対応が弱い、バリデーション機能なし

**他のNode.jsフレームワークとの比較:**

| フレームワーク | パフォーマンス | 学習曲線 | 適したユースケース |
|--------------|--------------|---------|------------------|
| **Express.js** | 基準 | ⭐️ 低 | 学習、小〜中規模プロジェクト |
| **Fastify** | 2-3倍速 | ⭐️⭐️ 中 | 本番運用、高トラフィックAPI |
| **NestJS** | 1-1.5倍速 | ⭐️⭐️⭐️⭐️ 高 | 大規模プロジェクト、チーム開発 |
| **Koa** | 1-1.2倍速 | ⭐️⭐️ 中 | モダンなマイクロサービス |

**このサンプルでExpress.jsを使用する理由:**

このサンプルは**学習用として最適な構成**です。Express.jsは業界標準であり、Web開発の基礎を学ぶのに最適です。

**本番運用の新規プロジェクトでは:**
- **Fastify** を推奨（パフォーマンスとTypeScript対応のバランスが良い）
- **NestJS** を推奨（大規模プロジェクトや10人以上のチーム開発）
